  ...
  <div class="order-right">
    <div class="order-content">
            ...
            <tr v-for="(goods, index) in order.orderDetailList" :key="goods.id">
              <td width="60%">
                <div class="typographic">
                  <img :src="goods.imgUrl" width="100" />
      ...
      <div class="choose-order">
        <!-- 分页器 -->
        <Pagination :pageNo="page" :pageSize="limit" :total="orderInfo.total" :continues="5" @pageChange="pageChangAndGoRequest"></Pagination>
      </div>
    </div>
    <!--猜你喜欢-->
    <div class="like">
...
export default {
  ...
  methods: {
    async getOrderList() {
      ...
      const res = await this.$API.reqGetOrderList(page, limit)
