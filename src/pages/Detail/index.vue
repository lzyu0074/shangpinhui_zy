          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd changepirce="0" :class="{ active: spuSaleAttrValue.isChecked === '1' }" v-for="spuSaleAttrValue in spuSaleAttr.spuSaleAttrValueList" :key="spuSaleAttrValue.id" @click="spuSaleAttrValueChange(spuSaleAttr.spuSaleAttrValueList, spuSaleAttrValue)">
...
export default {
  ...
  methods: {
    ...
    // 选择属性
    spuSaleAttrValueChange(valueList, valueObj) {
